...
from uo.algorithm.metaheuristic.variable_neighborhood_search.vns_ls_support_standard_bi_permutation \
    import VnsLocalSearchSupportStandardBestImprovementPermutation
...
class TestVnsLocalSearchSupportStandardBestImprovementPermutation(unittest.TestCase):

    def setUp(self):
        self.problem = ProblemVoidMinSO("void", True, False)
        self.representation = [2, 0, 1, 0, 2, 1]
        self.support = VnsLocalSearchSupportStandardBestImprovementPermutation(6)
    ...
    def test_dimension_of_wrong_type_raises_type_error(self):
        with self.assertRaises(TypeError):
            VnsLocalSearchSupportStandardBestImprovementPermutation(6.0)
    ...
    def test_local_search_sweeps_the_neighborhood_and_keeps_the_best(self):
        ...
        self.assertEqual(solution.objective_value, 2)
    ...
    def test_string_representations(self):
        ...
        self.assertEqual(text, 'VnsLocalSearchSupportStandardBestImprovementPermutation')
